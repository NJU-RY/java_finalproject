...
public class SixthBattlearray implements Battlearray {
    ...
    public void createbattlearray(Field f, boolean left) {
        ...
        if(left)
        {
            ...
            f.getSoldiers().add(two=new Soldiers(one));
            f.setposition(N/2+2,2,one=new Brothers(numbers++,N/2+2,2,f));
            f.getSoldiers().add(two=new Soldiers(one));
            f.setposition(N/2+1,3,one=new Brothers(numbers++,N/2+1,3,f));
            f.getSoldiers().add(two=new Soldiers(one));
            f.setposition(N/2,4,one=new Brothers(numbers++,N/2,4,f));
            f.getSoldiers().add(two=new Soldiers(one));
            f.setposition(N/2-1,3,one=new Brothers(numbers++,N/2-1,3,f));
            f.getSoldiers().add(two=new Soldiers(one));
            f.setposition(N/2-2,2,one=new Brothers(numbers++,N/2-2,2,f));
        ...
        else
        {
            ...
            f.setposition(N/2,M-5,one=new Scorpion(N/2,M-5,f));
            f.getMonstors().add(three=new Monstors(one));
            f.setposition(N/2-1,M-2,one=new Orchin(N/2-1,M-2,f));
            f.getMonstors().add(three=new Monstors(one));
            f.setposition(N/2-2,M-3,one=new Orchin(N/2-2,M-3,f));
            f.getMonstors().add(three=new Monstors(one));
            f.setposition(N/2-1,M-4,one=new Orchin(N/2-1,M-4,f));
            f.getMonstors().add(three=new Monstors(one));
            f.setposition(N/2+1,M-2,one=new Orchin(N/2+1,M-2,f));
            f.getMonstors().add(three=new Monstors(one));
            f.setposition(N/2+2,M-3,one=new Orchin(N/2+2,M-3,f));
