...
public class FirstBattlearray implements Battlearray {
    ...
    public void createbattlearray(Field f, boolean left) {
        ...
        {
            f.initSoldiers();
            f.setposition(N/2,M/6-3,one=new Grandpa(N/2,M/6-3,f));
        ...
        {
            f.initMonstors();
            f.setposition(N/2,5*M/6+3,one=new Snake_essence(N/2,5*M/6+3,f));
